<template>
  <footer class="toolbar toolbar-footer">
    <div class="toolbar-actions">
      ...
      <button v-if='!BUSY_FETCHINGARTICLES && ONLINE_STATUS && !BUSY_COMPACTING && !isOptionsMode' class="btn btn-primary pull-right" @click='forceArticleRefresh'>
        Refresh
      </button>
      <button v-if='BUSY_FETCHINGARTICLES && !BUSY_COMPACTING && ONLINE_STATUS && !isOptionsMode' class="btn btn-warning pull-right" disabled>Fetching</button>
      <button v-if='BUSY_COMPACTING && !BUSY_FETCHINGARTICLES && ONLINE_STATUS && !isOptionsMode' class="btn btn-warning pull-right" disabled>Compacting Database</button>
