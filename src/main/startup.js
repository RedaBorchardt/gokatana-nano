...
function checkStage15 () {
  if (!foundFeedsDB) {
    ...
    var samplefeeds = [
                       ...
                       { name: 'Evening Standard', retention: 7, maxitems: 400, uiorder: 5, rss: [{name: 'Latest News', url: 'http://www.standard.co.uk/rss'}], strategy: {useragent: 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36'}, host: 'www.standard.co.uk' },
                       { name: 'Focus', retention: 7, maxitems: 400, uiorder: 8,
                       ...
                       { name: 'Financial Times', retention: 7, maxitems: 400, uiorder: 11, rss: [{name: 'Latest News', url: 'http://search.ft.com/openSearch/atom/?searchTerms=&sortBy=date'}], strategy: {display: 'minioverride'}, host: 'ft.com' },
